<?php
  ...
  if (isset($_POST['nome']) && empty($_POST['nome']) == false) {
    ...
    $sql = "UPDATE administrador SET nome = '$nome', telefone = '$telefone', endereco = '$endereco', 
            cpf = '$cpf', dataNasc = '$dataNasc', salario = '$salario' WHERE id = '$id'";
    $PDO->query($sql);
...
<html lang="pt-br">
  ...
  <form method = "POST"> 
      ...
      CPF<br/>
      <input type="text" name="cpf" id="campoCpf" value="<?php echo $dado['cpf']; ?> "/><br/>
      Data de Nascimento<br/>
      <input type="text" name="dataNasc" id="campoData" value="<?php echo $dado['dataNasc']; ?> "/><br/>
      Salário<br/> 
      <input type="text" name="salario"  value="<?php echo $dado['salario']; ?> "/><br/>
      <br/>   
