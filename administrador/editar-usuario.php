<?php
  ...
  if(isset($_POST['email']) && empty($_POST['email']) == false){
    ...
    $tipo = addslashes($_POST['select']);

    $sql = "UPDATE usuario SET email = '$email', senha = '$senha', tipo = '$tipo' WHERE id = '$id'";
    $PDO->query($sql);
...
<html lang="pt-br">
  ...
  <form method = "POST"> 
      ...
      E-mail<br/>
      <input type="text" class="form-control" style="width: 25%;" name="email" required="true" value="<?php echo $dado['email']; ?> "/>
      Senha<br/>
      <input type="password" class="form-control" style="width: 25%;" name="senha" id="campoTelefone" required="true"/>
      Tipo
      <select class="form-control" name="select" style="width: 17%;">
        <option value="Administrador">Administrador</option>
        <option value="Funcionario">Funcionario</option>
      </select>
      <br/>
      <input type="submit" value = "&#10003 Alterar" class="btn btn-primary" />
      <a href="cadastro-usuario.php" class="btn btn-danger">&#10005 Cancelar</a>
