  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">Nessa pagina você pode realizar toda venda de produtos.</p>
        <p><a class="btn btn-lg btn-success" href="venda1.php" role="button">Área de Vendas</a></p>
      </div>

      <div class="jumbotron">
        <h1>Clientes</h1>
        <p class="lead">Nessa pagina você pode administrar todos os clientes.</p>
        <p><a class="btn btn-lg btn-success" href="cadastro-cliente.php" role="button">Clientes</a></p>
      </div>

      <div class="jumbotron">
        <h1>Exportar Informações</h1>
        <p class="lead">Nessa parte você pode exportar as informações relevantes para o excel.</p>
        <p><a class="btn btn-lg btn-success" href="exportar-produto.php" role="button">Exportar Produtos</a></p>
        <p><a class="btn btn-lg btn-success" href="exportar-administrador.php" role="button">Exportar Administradores</a></p>
        <p><a class="btn btn-lg btn-success" href="exportar-funcionario.php" role="button">Exportar Funcionarios</a></p>
        <p><a class="btn btn-lg btn-success" href="exportar-cliente.php" role="button">Exportar Clientes</a></p>
        <p><a class="btn btn-lg btn-success" href="exportar-venda.php" role="button">Exportar Vendas</a></p>
      </div>
