...
<html lang="pt-br">
  ...
  ?>
        <?php
          ...
          if($sql->rowCount() > 0){
            ...
            foreach ($sql-> fetchAll() as $produtos) {
              ...
              echo '<td><a href="editar-produto.php?id='.$produtos['id'].'" class="btn btn-warning">&#9999; Editar</a></td>';
              echo '<td><a href="excluir-produto.php?id='.$produtos['id'].'" class="btn btn-danger">&#10006; Excluir</a></td>';
              echo '</tbody>';
              echo '</tr>';
            } 
          } 
    ...
    <br>
    <a href="adicionar-produto.php" class="btn btn-success">&#10010; Novo produtos</a>
  ...
  <br>
      ...
      <div class="jumbotron">
        ...
        <p>Esta página é responsável pela manutenção dos produtos no sistema Lancho'System.</p>
      </div>
