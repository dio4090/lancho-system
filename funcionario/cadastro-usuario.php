        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="cadastro-usuario.php">Usuários</a></li>              
...
<html lang="pt-br">
  ...
  <?php
    ...
    if($sql->rowCount() == 0){
      ...
      echo '<strong>Aviso!</strong> Você ainda não possui usuários cadastrados.';
      echo '</div>';
  ...
  ?>
        ...
        <?php
          ...
          if($sql->rowCount() > 0){
            ...
            foreach ($sql-> fetchAll() as $usuario) {
                    echo '<td rowspan="2">'.$usuario['id'].'</td>';
                    echo'<td>'.$usuario['email']. '</td>';
                    echo'<td>'.$usuario['senha'].'</td>';
                    echo'<td>'.$usuario['tipo'].'</td>';
                    echo '<td><a href="editar-usuario.php?id='.$usuario['id'].'" class="btn btn-warning">&#9999; Editar</a></td>';
                    echo '<td><a href="excluir-usuario.php?id='.$usuario['id'].'" class="btn btn-danger">&#10006; Excluir</a></td>';
                echo '</tbody>';
              echo '</tr>';
            } 
          } 
      ...
      <a href="adicionar-usuario.php" class="btn btn-success">&#10010; Novo usuário</a>
  ...
  <br>
      ...
      <div class="jumbotron">
        ...
        <p>Esta página é responsável pela manutenção dos usuários do sistema Lancho'System.</p>
      </div>
