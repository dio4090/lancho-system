<?php
  ...
  if (isset($_POST['nome']) && empty($_POST['nome']) == false) {
    ...
    $sql = "UPDATE produtos SET nome = '$nome', valor = '$valor', fornecedor = '$fornecedor' WHERE id = '$id'";
    $PDO->query($sql);
...
<html lang="pt-br">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="inicial-produto.php">Produtos</a></li>  
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </nav>
  ...
  <form method = "POST"> 
      ...
      Valor<br/>
      <input type="text" name="valor" value="<?php echo $dado['valor']; ?> "/><br/>
      Fornecedor<br/>
      <input type="text" name="fornecedor" value="<?php echo $dado['fornecedor']; ?> "/><br/>
      <br/>   
      <input type="submit" value = "&#10003 Alterar" class="btn btn-primary" />
      <a href="cadastro-produto.php" class="btn btn-danger">&#10005 Cancelar</a>
