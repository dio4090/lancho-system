...
<html lang="pt-br">
  ...
  <form method = "POST"> 
      ...
      E-mail<br/>
      <input type="text" name="email" required="true" value="<?php echo $dado['email']; ?> "/><br/>
      Senha<br/>
      <input type="password" name="senha" id="campoTelefone" required="true"/><br/>
      Tipo<br/>
      <input type="text" name="tipo" required="true" value="<?php echo $dado['tipo']; ?> "/><br/>
      <br/>   
